    ...
    <>
      ...
      <aside
        ...
        className={`fixed md:sticky top-0 z-50 md:z-auto h-screen border-r flex flex-col justify-between py-4 shrink-0 
          ...
          ${isMobileOpen ? 'translate-x-0 w-64 shadow-2xl px-4' : '-translate-x-full md:translate-x-0'}
          ${isCollapsed ? 'md:w-16 md:px-2' : 'md:w-64 md:px-4'}
        `}
      >
        <div className="flex flex-col h-full overflow-hidden">
          <div className={`flex items-center mb-6 h-10 shrink-0 w-full ${
            isCollapsed ? 'md:flex-col md:h-auto md:gap-3 md:justify-center' : 'justify-between'
          }`}>
            <Link
              href="/admin"
          ...
          <div className="pt-4 mt-auto border-t border-[var(--border-color)] shrink-0 w-full">
            <Link
              ...
              className={`flex items-center text-xs py-2.5 rounded-lg text-[var(--text-secondary)] hover:bg-[var(--bg-accent)] hover:text-[var(--text-primary)] transition-colors ${
