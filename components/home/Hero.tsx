...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pt-6 pb-10 md:pt-10 md:pb-16 bg-[var(--bg-primary)]">
      <div 
        aria-hidden="true" 
        className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] bg-gradient-to-tr from-[#3B82F6]/20 to-[#2DD4BF]/20 blur-[120px] pointer-events-none rounded-full" 
      />
