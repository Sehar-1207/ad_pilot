    ...
    >
      <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
        ...
        >
          ...
          <option value="paused" className="bg-slate-900 text-white">
            Paused
          </option>
        </select>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          onClick={onSync}
          disabled={isSyncing}
          className="flex items-center justify-center gap-2 rounded-lg bg-teal-500 px-4 py-2 text-xs font-semibold text-white hover:bg-teal-600 transition-colors shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
        >
          <RefreshCw
          ...
          <span>
            {isSyncing ? 'Syncing...' : 'Sync Meta Data'}
          </span>
        </button>
      </div>
    </div>
