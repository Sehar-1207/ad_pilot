...
if (loading) {
return ( <section className="w-full py-9 md:py-14 bg-[var(--bg-primary)] transition-colors duration-300"> <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> <div className="min-h-[500px] flex items-center justify-center"> <RefreshCw className="w-6 h-6 animate-spin text-[var(--primary)]" /> </div> </div> </section>
);
}

return ( <section className="w-full py-9 md:py-14 bg-[var(--bg-primary)] transition-colors duration-300"> <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> <div className="text-center max-w-3xl mx-auto mb-12 space-y-4"> <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[var(--bg-accent)] border border-[var(--border-color)] text-xs font-semibold text-[var(--text-primary)]"> <Zap className="w-4 h-4 text-[#3B82F6]" /> <span>Simple, Transparent Pricing</span> </div>
