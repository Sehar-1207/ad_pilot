      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-sm sm:text-base text-[var(--text-secondary)]">
            Have questions about our AI campaign optimization or custom enterprise setup? Send us a message.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="rounded-3xl p-8 bg-[var(--bg-surface)] border border-[var(--border-color)] shadow-sm space-y-6">
              ...
              <p className="text-xs sm:text-sm text-[var(--text-secondary)] leading-relaxed">
                Reach out directly or fill out the form. Our support and onboarding specialists respond within 24 hours.
              </p>
              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs text-[var(--text-secondary)] font-medium">Email Us</p>
                    <a href={`mailto:${email}`} className="text-sm font-semibold text-[var(--text-primary)] hover:underline">
                      {email}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs text-[var(--text-secondary)] font-medium">Call Us</p>
                    <a href={`tel:${phoneNo.replace(/\s+/g, '')}`} className="text-sm font-semibold text-[var(--text-primary)] hover:underline">
                      {phoneNo}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs text-[var(--text-secondary)] font-medium">Headquarters</p>
            ...
            <div className="rounded-3xl p-6 bg-[var(--bg-surface)] border border-[var(--border-color)] shadow-sm flex items-center gap-4">
              ...
              <div>
                <h3 className="text-sm font-bold text-[var(--text-primary)]">Priority Support Hours</h3>
                <p className="text-xs text-[var(--text-secondary)]">Mon - Fri: 24 Hours | Sat - Sun: 9am - 5pm EST</p>
              </div>
            </div>
          </div>
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full py-3.5 px-6 rounded-2xl text-sm font-semibold text-white bg-gradient-to-r from-[#3B82F6] to-[#2DD4BF] hover:opacity-95 shadow-md shadow-[#3B82F6]/20 transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
                >
                  {isSubmitting ? (
                    <span>Sending...</span>
                  ) : (
